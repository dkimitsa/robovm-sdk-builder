...
public final class MachOConsts {
    ...
    public static final class commands {
        ...
        public static final int LC_UUID = 0x1b; /* the uuid */
        public static final int LC_ID_DYLIB = 0xd; /* dynamically linked shared lib ident */
        public static final int LC_REEXPORT_DYLIB = 0x1f | LC_REQ_DYLD;
        public static final int LC_LOAD_WEAK_DYLIB = 0x18 | LC_REQ_DYLD;

        public static final int LC_DYLD_INFO = 0x22; /* compressed dyld information */
        public static final int LC_DYLD_INFO_ONLY = (0x22| LC_REQ_DYLD); /* compressed dyld information only */
    }
    ...
    public static class nlist {
        ...
        public static final int N_WEAK_DEF = 0x0080;
    ...
    public static class trie {
        ...
        public static final int EXPORT_SYMBOL_FLAGS_REEXPORT = 0x08;
        public static final int EXPORT_SYMBOL_FLAGS_STUB_AND_RESOLVER = 0x10;
    }
